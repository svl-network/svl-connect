...
package net.sunveil.connect.launcher.impl;

import net.sunveil.connect.utils.Parameters;
import net.sunveil.connect.utils.ReflectionUtils;
...
public final class StandardLauncher extends AbstractLauncher {
    ...
    public void launch() throws Throwable {
        ...
        System.setProperty("net.sunveil.connect.launch.mainclass", mainClassName);
        // unit separator ('\u001F') delimited list of game args
        System.setProperty("net.sunveil.connect.launch.gameargs", joinedGameArgs.toString());
